...
$sql = "SELECT tservice_name as monthse,COUNT('hl_code') AS 'tservice'  FROM typeservicedetail 
        INNER JOIN typeservice ON typeservice.tservice_code = typeservicedetail.tservice_code
        INNER JOIN homeless ON homeless.hl_code = typeservicedetail.hl_code 
        INNER JOIN homelessdetail ON homelessdetail.hl_code = homeless.hl_code
        ".$where."
        GROUP BY typeservice.tservice_name ";
//}
