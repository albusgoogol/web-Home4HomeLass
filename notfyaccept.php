  ...
  <head>
    ...
    <script language="javascript">
        function fncSubmit()
        {
          ...
          document.frmMain.action="notfyaccept1.php";
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">แบบบันทึกการเข้ารับบริการ > จากการรับแจ้งขอความช่วยเหลือ</h2>
            <form name="frmMain" id="frmMain" action="" class="templatemo-login-form" method="post" onSubmit="JavaScript:return fncSubmit();" >
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input name="autocomplete" id="autocomplete"class="form-control" type="text" value="<?php echo $rsnotyfy['hlin_location'] ;?>" disabled></input>
                    <input type="hidden" name="location" id="location" value="<?php echo $rsnotyfy['hlin_location'] ;?>">         
                </div>
