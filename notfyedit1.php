...
<!DOCTYPE html>
  <head>
    ...
    <title>Home4Homeless | บันทึกรายงาน</title>
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="record.php"  class="active"><i class="fa fa-edit fa-fw"></i>บันทึกรายงาน</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">แบบบันทึกรายงานการสำรวจเข้ารับบริการ (ต่อ)</h2>
