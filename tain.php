  ...
  $(document).ready(function() {
    ...
    <!--   Script function AJAX  Address  -->
        ...
        function dochange(src,val) {
             ...
             req.open("GET","localcareer.php?data="+src+"&val="+val); //สร้าง connection
             req.setRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf-8"); // set Header
             req.send(null); //ส่งค่า
        }

        window.onLoad=dochange('oc',-1);     
    </script>
    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <h2 class="margin-bottom-10">ค้นหารายงาน > ติดตามช่วยเหลือ > แบบบันทึกติดตามความช่วยเหลือการฝึกอาชีพ</h2>
            <form name="frmMain" id="frmMain" action="db_trian.php" class="templatemo-login-form" method="post">
              <div class="row form-group">
                  ...
                  <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <?php  
                      ...
                      //echo $date;
                    ?>
                    <input type="hidden" class="form-control" name="tday" id="tday" value="<?php echo $date?>"/>
                </div>
              </div>
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" class="form-control" name="day" id="datepicker1"data-provide="datepicker" data-date-language="th-th" placeholder="วว/ดด/ปปปป" required> </input> 
                  </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block" for="oc">อาชีพ *</label>   
                  <span id="oc">              
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block" for="ta">ศูนย์ฝึกอาชีพ *</label>   
                  <span id="ta">              
                  <select class="form-control" name="ta" id="ta">
                    <option value="0">-- เลือกศูนย์ฝึกอาชีพ --</option>
              ...
              <div class="form-group text-right">
                ...
                <button class="templatemo-white-button"><a href="addoc.php?show_id=<?php echo $show_id;?>" target='_blank'>เพิ่มอาชีพ/ศูนย์ฝึกอาชีพ</a></button>
              </div> 
            </form>
            <h2 class="margin-bottom-10">ประวัติการฝึกอาชีพ</h2>
            <form name="frmMain" id="frmMain" action="" class="templatemo-login-form" method="post" >
                  ...
                  <table id="myTable" class="table table-striped table-bordered templatemo-user-table display" cellspacing="0"  width="100%"> 
                    <?php
                      $sql = "SELECT * FROM homeless
                              ...
                              WHERE trainingcenterdetail.hl_code = '$show_id' AND trainingcenterdetail.traincenter_status = 'ฝึกอาชีพ'
                              ORDER BY trainingcenterdetail.traincenter_day ASC";
                      $query = mysql_query($sql);
                    ?>
                    <thead>
                      <tr>
                        <td class="white-text templatemo-sort-by" align="center">วันที่บันทึกข้อมูล<span class="caret"></span></td>
                        <td class="white-text templatemo-sort-by"align="center">อาชีพ<span class="caret"></span></td>
                        <td class="white-text templatemo-sort-by"align="center">ศูนย์ฝึกอาชีพ<span class="caret"></span></td>
                    ...
                    <?php
                        while($rs = mysql_fetch_assoc($query)){
                          echo "<tr>";
                          //echo $rs['course_name'];
                            echo "<td width='40' ><div align='center'>$rs[traincenter_day]</div></td>";
                            echo "<td width='68'><div align='center'>$rs[course_name]</div></td>";
                            echo "<td width='120'><div align='center'>$rs[traincenter_name]</div></td>";
                            echo "<td width='70'><div align='center'><a href='trainshow.php?show_id=$show_id&&course_code=$rs[course_code]&&train_code=$rs[traincenter_code]' target ='_blank'>ดูรายละเอียด</a></div></td>";
                            echo "<td width='68'><div align='center'><a href='deltrain.php?show_id=$show_id&&course_code=$rs[course_code]&&train_code=$rs[traincenter_code]'><i class='fa fa-trash fa-fw'></i></a></div></td>";
                          echo "</tr>";
                        }
                      mysql_close();
                      ?>
              ...
              <FONT COLOR=red>*หมายเหตุ: สามารถค้นหาได้จากวันที่บันทึกข้อมูล, อาชีพ, ศูนย์ฝึกอาชีพ  </FONT>
            </form>
          </div>
