    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <h2 class="margin-bottom-10">ค้นหารายงาน > ติดตามช่วยเหลือ > ประวัติสถานที่รับดูแล</h2>
            <form name="frmMain" id="frmMain" action="" class="templatemo-login-form" method="post">
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rstc['hl_fname'];?>      <?php echo $rstc['hl_lname'];?></label>
                    &nbsp;&nbsp;&nbsp;&nbsp;<label>วันที่เข้ารับดูแล </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo displaydate($rstc['td_in']);?> </label><br>
                    <label for="">ชื่อสถานที่รับดูแล </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $tc_name;?> </label> <br>
                    <label for="">เบอร์โทรศัพท์ </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rstc['tc_tel'];?> </label>
                    <label for="">อีเมล </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rstc['tc_email'];?> </label> <br>
                    <label for="">รายละเอียดช่องทางการติดต่อ </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rstc['tc_contact'];?> </label> <br>
                    ...
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rs3['GEO_NAME'];?> </label><br>
                    <label for="">รายละเอียดสถานที่รับดูแล </label>
                    <label class="font-weight-400">&nbsp; &nbsp;&nbsp;<?php echo $rstc['td_contactdetail'];?> </label>

                  </div>
              </div>
          
              <div class="form-group text-right">
                <button type="submit" class="templatemo-white-button"><a href="takecare.php?show_id=<?php echo $show_id; ?>">กลับ</a></button>
