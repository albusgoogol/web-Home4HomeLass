...
$sql = "SELECT cause_name as monthse,COUNT('hl_code') AS 'cause'  FROM causedetail 
        INNER JOIN cause ON cause.cause_code = causedetail.cause_code
        INNER JOIN homeless ON homeless.hl_code = causedetail.hl_code 
